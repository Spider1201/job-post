...
function JobCard({ logo, title, company, location, jobType, salary, skills, experience }) {
  ...
  return (
    <>
      ...
      <JobDetailsModal job={jobData} isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </>
  )
}
